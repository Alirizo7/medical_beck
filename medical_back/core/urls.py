...
from .views import register_doctor, login_doctor, get_user_profile, update_user_profile, \
    ...
    UserDeactivateAPIView, MedicationDeleteAPIView
...
urlpatterns = [
    ...
    path('patients/<int:pk>/', UpdatePatientView.as_view(), name='update-patient-detail'),
    ...
    path('medication-delete/<int:pk>/', MedicationDeleteAPIView.as_view(), name='medication-delete'),
]
